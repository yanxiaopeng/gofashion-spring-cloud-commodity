			...
			<div class="lh-wrap">
				<div class="p-img">
					<a target="_blank" href="https://item.jd.com/100000287117.html">
						<img width="220" height="282" class="err-product" src="${item.gspubrand_picture }">
					</a>
				</div>
				<div class="p-name">
					<a target="_blank" href="#">${item.gskuspec_name }</a>
				</div>
				<div class="p-name">
					<a target="_blank" href="#">${item.gskuspec_headline}</a>
				</div>
				<div class="p-name">
					<a target="_blank" href="#">${item.gspufirstgrade_name}</a>&nbsp;
					<a target="_blank" href="#">${item.gspsecondgrade_name}</a>&nbsp;
					<a target="_blank" href="#">${item.gskuspec_name}</a>&nbsp;


				</div>
				<div class="p-price">
					<strong>￥<fmt:formatNumber value="${item.gskuspec_price }" maxFractionDigits="2"/></strong><span id="p1269191543"></span>
				</div>
			</div>
		</li>
		</c:forEach>
